...
AulasComponent.ɵfac = function AulasComponent_Factory(t) { return new (t || AulasComponent)(); };
...
function CursobyidComponent_div_0_mat_card_28_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate1"]("value", "http://localhost:5000/video/", aula_r3.videoAula, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate1"]("src", "http://localhost:5000/video/", aula_r3.videoAula, "", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeResourceUrl"]);
} }
...
class CursoService {
    constructor(http) {
        this.http = http;
        this.baseUrl = 'http://localhost:5000/api/curso';
    }
    /*getCurso() {
